...
<template>
    <div align="center">      
        <v-card width="500px" class=" mx-2 my-2">
            ...
            <v-card-actions>
                <v-spacer></v-spacer> 
                <v-btn class="red white--text" @click="deleteAllHistory()" depressed>
                    Hapus Semua
                </v-btn>
                <v-spacer></v-spacer>
            </v-card-actions>
...
export default {
    ...
    methods : {
        ...
        /* method compare, 
         * if history is new, then return true
         */ 
        ...
        // method to retrieve all history from database
        getAllHistory(){
            this.history = [];
            console.log("test")
            History.getAllHistory().then((response)=>{
        ...
        // convert timestamp to stopwatch format
        ...
        // convert timestamp to a sentence
