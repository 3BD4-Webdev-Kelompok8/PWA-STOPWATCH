    ...
    <v-row class="d-flex justify-start mb-6" >
        <v-col class="mx-4">
            ...
            >
                ...
                <v-card-actions>
                    <v-spacer></v-spacer>
                    <v-btn class="blue white--text" depressed @click="createStopwatch()">
                        Create
                    </v-btn>
                </v-card-actions>
            </v-card>  
...
export default {
    ...
    methods : {
        // Method to delete 1 stopwatch
        deleteStopwatch(id){
            Stopwatch.deleteStopwatchByID(id).then((response)=>{
                console.log(response)  
                this.getAllStopwatch(false)  
            })
        },

        // convert timestamp to stopwatch
        ...
        // Method to creat new stopwatch 
        createStopwatch(){
            this.data.nama = this.newstopwatch
          
            Stopwatch.createStopwatch(this.data).then(response => {
        ...
        // Method to add stopwatch to array
        ...
        // Method to retrieve stopwatch
        getAllStopwatch(firstTime){
            Stopwatch.getAllStopwatch().then((response)=>{
        ...
        // Method to stop stopwatch and insert to rekap
        stop(index){
            this.stopwatch[index].status = false
            clearInterval(this.interval);
